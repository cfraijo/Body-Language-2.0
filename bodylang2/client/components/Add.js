...
var toneScore = [];
var toneRes = [];
var theText = require("WatsonText")
var forWatson = document.getElementById(theText.emotionalText)
        ...
        fetch(
            var tone_analyzer = new ToneAnalyzerV3({
              ...
              tone_analyzer.tone(
                ...
                return(
                    <div key={watson.results}>
                        <h3>watEmo</h3>

                    </div>
                )
            })
            this.setState({emotion: watEmo});
            console.log("state", this.state.watEmo);
    })
}
